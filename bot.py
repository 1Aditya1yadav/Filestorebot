    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Telegram Channel List", url="https://t.me/+VsEgtXo5b4thOTc1")
                    ],
                    [
                    ...
                    [
                        InlineKeyboardButton("YouTube Channel", url=" https://www.youtube.com/channel/UCF3LQyme6yNNbLXB8bhvs8Q/"),
                        InlineKeyboardButton(" Support Channel", url=" https://t.me/+RqxzcGxXVZM0N2Vl")
                    ]
                ]
            )
        )
...
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == enums.ChatType.PRIVATE:
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("Sorry, You are banned!\n\nContact [Support Group]( https://t.me/+RqxzcGxXVZM0N2Vl)",
                                     disable_web_page_preview=True)
            return
        ...
        try:
            ...
            share_link = f"https://t.me/{Config.BOT_USERNAME}?start=Megalinksfree_{str_to_b64(file_er_id)}"
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [Support Channel](https://t.me/+RqxzcGxXVZM0N2Vl).",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await cmd.message.edit(
                    text="Something went Wrong. Contact my [Support Channel](https://t.me/+RqxzcGxXVZM0N2Vl).",
                    disable_web_page_preview=True
                )
                return
        await cmd.message.edit(
